...
- Topics track state on their icon (custom emoji, not unicode): 💻 working · 💬 idle · ✅ done · ❗️ blocked · 🏁 closed · ❓ unknown. Titles sync 1:1 with herdr pane names either way (rename the topic or the pane).
